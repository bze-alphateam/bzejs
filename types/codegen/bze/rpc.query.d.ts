...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    bze: {
        ...
        cointrunk: {
            v1: {
                params(request?: import("../beezee/cointrunk/query").QueryParamsRequest): Promise<import("../beezee/cointrunk/query").QueryParamsResponse>;
                acceptedDomain(request?: import("../beezee/cointrunk/query").QueryAcceptedDomainRequest): Promise<import("../beezee/cointrunk/query").QueryAcceptedDomainResponse>;
                publisher(request?: import("../beezee/cointrunk/query").QueryPublisherRequest): Promise<import("../beezee/cointrunk/query").QueryPublisherResponse>;
                publisherByIndex(request: import("../beezee/cointrunk/query").QueryPublisherByIndexRequest): Promise<import("../beezee/cointrunk/query").QueryPublisherByIndexResponse>;
                allArticles(request?: import("../beezee/cointrunk/query").QueryAllArticlesRequest): Promise<import("../beezee/cointrunk/query").QueryAllArticlesResponse>;
