...
export type MsgSubmitProposalEncoded = Omit<MsgSubmitProposal, "content"> & {
   ...
   * content is the proposal's content.
   */
  content?: AcceptedDomainProposalProtoMsg | PublisherProposalProtoMsg | CommunityPoolSpendProposalProtoMsg | CommunityPoolSpendProposalWithDepositProtoMsg | TextProposalProtoMsg | ParameterChangeProposalProtoMsg | SoftwareUpgradeProposalProtoMsg | CancelSoftwareUpgradeProposalProtoMsg | AnyProtoMsg | undefined;
};
/**
 * MsgSubmitProposal defines an sdk.Msg type that supports submitting arbitrary
 * proposal Content.
...
export const MsgSubmitProposal = {
  ...
  registerTypeUrl() {
    ...
    AcceptedDomainProposal.registerTypeUrl();
    PublisherProposal.registerTypeUrl();
