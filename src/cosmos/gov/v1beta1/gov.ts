...
export type ProposalEncoded = Omit<Proposal, "content"> & {
   ...
   * content is the proposal's content.
   */
  content?: TextProposalProtoMsg | AcceptedDomainProposalProtoMsg | PublisherProposalProtoMsg | CommunityPoolSpendProposalProtoMsg | CommunityPoolSpendProposalWithDepositProtoMsg | ParameterChangeProposalProtoMsg | SoftwareUpgradeProposalProtoMsg | CancelSoftwareUpgradeProposalProtoMsg | AnyProtoMsg | undefined;
};
/**
 * Proposal defines the core field members of a governance proposal.
 * @name ProposalAmino
