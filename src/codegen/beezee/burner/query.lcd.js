...
var LCDQueryClient = /** @class */ (function () {
    ...
    LCDQueryClient.prototype.raffles = function (params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "bze/burner/v1/raffles";
    ...
    LCDQueryClient.prototype.raffleWinners = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options, endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "bze/burner/v1/raffle_winners";
                        return [4 /*yield*/, this.req.get(endpoint, options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    /* AllBurnedCoins */
    LCDQueryClient.prototype.allBurnedCoins = function (params) {
        if (params === void 0) { params = {
            pagination: undefined
        }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "bze/burner/v1/all_burned_coins";
                        return [4 /*yield*/, this.req.get(endpoint, options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
