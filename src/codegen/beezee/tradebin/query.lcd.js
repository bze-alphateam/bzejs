...
var LCDQueryClient = /** @class */ (function () {
    ...
    LCDQueryClient.prototype.params = function (_params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "bze/tradebin/v1/params";
    ...
    LCDQueryClient.prototype.market = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (typeof (params === null || params === void 0 ? void 0 : params.base) !== "undefined") {
                            options.params.base = params.base;
                        }
                        if (typeof (params === null || params === void 0 ? void 0 : params.quote) !== "undefined") {
                            options.params.quote = params.quote;
                        }
                        endpoint = "bze/tradebin/v1/market";
    ...
    LCDQueryClient.prototype.marketAll = function (params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "bze/tradebin/v1/all_markets";
                        return [4 /*yield*/, this.req.get(endpoint, options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    LCDQueryClient.prototype.assetMarkets = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options, endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "bze/tradebin/v1/asset_markets";
                        return [4 /*yield*/, this.req.get(endpoint, options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    LCDQueryClient.prototype.userMarketOrders = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options, endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (typeof (params === null || params === void 0 ? void 0 : params.market) !== "undefined") {
                            options.params.market = params.market;
                        }
                        if (typeof (params === null || params === void 0 ? void 0 : params.pagination) !== "undefined") {
                            (0, helpers_1.setPaginationParams)(options, params.pagination);
                        }
                        endpoint = "bze/tradebin/v1/user_market_orders/".concat(params.address);
                        return [4 /*yield*/, this.req.get(endpoint, options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    LCDQueryClient.prototype.marketAggregatedOrders = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options, endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "bze/tradebin/v1/market_aggregated_orders";
                        return [4 /*yield*/, this.req.get(endpoint, options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    LCDQueryClient.prototype.marketHistory = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options, endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "bze/tradebin/v1/market_history";
                        return [4 /*yield*/, this.req.get(endpoint, options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    LCDQueryClient.prototype.marketOrder = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options, endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (typeof (params === null || params === void 0 ? void 0 : params.orderId) !== "undefined") {
                            options.params.order_id = params.orderId;
                        }
                        endpoint = "bze/tradebin/v1/market_order";
                        return [4 /*yield*/, this.req.get(endpoint, options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
