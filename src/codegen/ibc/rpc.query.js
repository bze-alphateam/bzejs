    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_5) {
            switch (_5.label) {
                ...
                case 6:
                    _c.base = (_h.tendermint = (_j.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _j),
                        _h);
                    _k = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/distribution/v1beta1/query.rpc.Query")); })];
                case 7:
                    _c.distribution = (_k.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _k);
                    _l = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/evidence/v1beta1/query.rpc.Query")); })];
                case 8:
                    _c.evidence = (_l.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _l);
                    _m = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/feegrant/v1beta1/query.rpc.Query")); })];
                case 9:
                    _c.feegrant = (_m.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _m);
                    _o = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/gov/v1/query.rpc.Query")); })];
                case 10:
                    _o.v1 = (_5.sent()).createRpcQueryExtension(client);
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/gov/v1beta1/query.rpc.Query")); })];
                case 11:
                    _c.gov = (_o.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _o);
                    _p = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/group/v1/query.rpc.Query")); })];
                case 12:
                    _c.group = (_p.v1 = (_5.sent()).createRpcQueryExtension(client),
                        _p);
                    _q = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/mint/v1beta1/query.rpc.Query")); })];
                case 13:
                    _c.mint = (_q.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _q);
                    _r = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/nft/v1beta1/query.rpc.Query")); })];
                case 14:
                    _c.nft = (_r.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _r);
                    _s = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/params/v1beta1/query.rpc.Query")); })];
                case 15:
                    _c.params = (_s.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _s);
                    _t = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/slashing/v1beta1/query.rpc.Query")); })];
                case 16:
                    _c.slashing = (_t.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _t);
                    _u = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/staking/v1beta1/query.rpc.Query")); })];
                case 17:
                    _c.staking = (_u.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _u);
                    _v = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/tx/v1beta1/service.rpc.Service")); })];
                case 18:
                    _c.tx = (_v.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _v);
                    _w = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/upgrade/v1beta1/query.rpc.Query")); })];
                case 19:
                    _b.cosmos = (_c.upgrade = (_w.v1beta1 = (_5.sent()).createRpcQueryExtension(client),
                        _w),
                        _c);
                    _x = {};
                    _y = {};
                    _z = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("./applications/transfer/v1/query.rpc.Query")); })];
                case 20:
                    _x.applications = (_y.transfer = (_z.v1 = (_5.sent()).createRpcQueryExtension(client),
                        _z),
                        _y);
                    _0 = {};
                    _1 = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("./core/channel/v1/query.rpc.Query")); })];
                case 21:
                    _0.channel = (_1.v1 = (_5.sent()).createRpcQueryExtension(client),
                        _1);
                    _2 = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("./core/client/v1/query.rpc.Query")); })];
                case 22:
                    _0.client = (_2.v1 = (_5.sent()).createRpcQueryExtension(client),
                        _2);
                    _3 = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("./core/connection/v1/query.rpc.Query")); })];
                case 23:
                    _0.connection = (_3.v1 = (_5.sent()).createRpcQueryExtension(client),
                        _3);
                    _4 = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("./core/port/v1/query.rpc.Query")); })];
                case 24: return [2 /*return*/, (_b.ibc = (_x.core = (_0.port = (_4.v1 = (_5.sent()).createRpcQueryExtension(client),
                        _4),
                        _0),
                        _x),
                        _b)];
