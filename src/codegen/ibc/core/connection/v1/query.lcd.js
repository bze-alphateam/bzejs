...
var LCDQueryClient = /** @class */ (function () {
    ...
    LCDQueryClient.prototype.connection = function (params) {
    ...
    LCDQueryClient.prototype.connections = function (params) {
    ...
    /* ClientConnections queries the connection paths associated with a client
     state. */
    LCDQueryClient.prototype.clientConnections = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    /* ConnectionClientState queries the client state associated with the
     connection. */
    LCDQueryClient.prototype.connectionClientState = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    /* ConnectionConsensusState queries the consensus state associated with the
     connection. */
    LCDQueryClient.prototype.connectionConsensusState = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
