...
var MsgClientImpl = /** @class */ (function () {
    ...
    MsgClientImpl.prototype.send = function (request) {
        ...
        return promise.then(function (data) { return tx_1.MsgSendResponse.decode(new _m0.Reader(data)); });
    };
    MsgClientImpl.prototype.multiSend = function (request) {
        ...
        return promise.then(function (data) { return tx_1.MsgMultiSendResponse.decode(new _m0.Reader(data)); });
    };
