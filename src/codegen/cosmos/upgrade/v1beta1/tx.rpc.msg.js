...
var MsgClientImpl = /** @class */ (function () {
    ...
    MsgClientImpl.prototype.softwareUpgrade = function (request) {
        ...
        return promise.then(function (data) { return tx_1.MsgSoftwareUpgradeResponse.decode(new _m0.Reader(data)); });
    };
    MsgClientImpl.prototype.cancelUpgrade = function (request) {
        ...
        return promise.then(function (data) { return tx_1.MsgCancelUpgradeResponse.decode(new _m0.Reader(data)); });
    };
