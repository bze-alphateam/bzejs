...
var MsgClientImpl = /** @class */ (function () {
    ...
    MsgClientImpl.prototype.createVestingAccount = function (request) {
        ...
        return promise.then(function (data) { return tx_1.MsgCreateVestingAccountResponse.decode(new _m0.Reader(data)); });
    };
    MsgClientImpl.prototype.createPermanentLockedAccount = function (request) {
        ...
        return promise.then(function (data) { return tx_1.MsgCreatePermanentLockedAccountResponse.decode(new _m0.Reader(data)); });
    };
    MsgClientImpl.prototype.createPeriodicVestingAccount = function (request) {
        ...
        return promise.then(function (data) { return tx_1.MsgCreatePeriodicVestingAccountResponse.decode(new _m0.Reader(data)); });
    };
