...
var LCDQueryClient = /** @class */ (function () {
    ...
    LCDQueryClient.prototype.getTx = function (params) {
    ...
    LCDQueryClient.prototype.getTxsEvent = function (params) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    LCDQueryClient.prototype.getBlockWithTxs = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options, endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
