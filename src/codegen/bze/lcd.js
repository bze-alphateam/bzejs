        ...
        return __generator(this, function (_3) {
            switch (_3.label) {
                case 0:
                    ...
                    _c = {};
                    _d = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../beezee/burner/query.lcd")); })];
                case 1:
                    _c.burner = (_d.v1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _d);
                    _e = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../beezee/cointrunk/query.lcd")); })];
                case 2:
                    _c.cointrunk = (_e.v1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _e);
                    _f = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../beezee/epochs/query.lcd")); })];
                case 3:
                    _c.epochs = (_f.v1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _f);
                    _g = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../beezee/rewards/query.lcd")); })];
                case 4:
                    _c.v1 = (_g.rewards = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _g);
                    _h = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../beezee/tokenfactory/query.lcd")); })];
                case 5:
                    _c.tokenfactory = (_h.v1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _h);
                    _j = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../beezee/tradebin/query.lcd")); })];
                case 6:
                    _b.bze = (_c.tradebin = (_j.v1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _j),
                        _c);
                ...
                case 7:
                    _k.auth = (_l.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _l);
                    _m = {};
                ...
                case 8:
                    _k.authz = (_m.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _m);
                    _o = {};
                ...
                case 9:
                    _k.bank = (_o.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _o);
                    _p = {};
                ...
                case 10:
                    _k.base = (_p.tendermint = (_q.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _q),
                        _p);
                ...
                case 11:
                    _k.distribution = (_r.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _r);
                    _s = {};
                ...
                case 12:
                    _k.evidence = (_s.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _s);
                    _t = {};
                ...
                case 13:
                    _k.feegrant = (_t.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _t);
                    _u = {};
                ...
                case 16:
                    _k.group = (_v.v1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _v);
                    _w = {};
                ...
                case 17:
                    _k.mint = (_w.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _w);
                    _x = {};
                ...
                case 18:
                    _k.nft = (_x.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _x);
                    _y = {};
                ...
                case 19:
                    _k.params = (_y.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _y);
                    _z = {};
                ...
                case 20:
                    _k.slashing = (_z.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _z);
                    _0 = {};
                ...
                case 21:
                    _k.staking = (_0.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _0);
                    _1 = {};
                ...
                case 22:
                    _k.tx = (_1.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _1);
                    _2 = {};
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../cosmos/upgrade/v1beta1/query.lcd")); })];
                case 23: return [2 /*return*/, (_b.cosmos = (_k.upgrade = (_2.v1beta1 = new (_3.sent()).LCDQueryClient({
                        requestClient: requestClient
                    }),
                        _2),
                        _k),
