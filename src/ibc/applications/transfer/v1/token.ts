...
export const Token = {
  ...
  isSDK(o: any): o is TokenSDKType {
    return o && (o.$typeUrl === Token.typeUrl || Denom.isSDK(o.denom) && typeof o.amount === "string");
  },
...
export const Denom = {
  ...
  isSDK(o: any): o is DenomSDKType {
    return o && (o.$typeUrl === Denom.typeUrl || typeof o.base === "string" && Array.isArray(o.trace) && (!o.trace.length || Hop.isSDK(o.trace[0])));
  },
