...
export const GenesisCounterpartyInfo = {
  ...
  isSDK(o: any): o is GenesisCounterpartyInfoSDKType {
    return o && (o.$typeUrl === GenesisCounterpartyInfo.typeUrl || typeof o.client_id === "string" && CounterpartyInfo.isSDK(o.counterparty_info));
  },
...
export const GenesisState = {
  ...
  isSDK(o: any): o is GenesisStateSDKType {
    return o && (o.$typeUrl === GenesisState.typeUrl || Array.isArray(o.counterparty_infos) && (!o.counterparty_infos.length || GenesisCounterpartyInfo.isSDK(o.counterparty_infos[0])));
  },
