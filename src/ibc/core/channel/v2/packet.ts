...
export const Packet = {
  ...
  isSDK(o: any): o is PacketSDKType {
    return o && (o.$typeUrl === Packet.typeUrl || typeof o.sequence === "bigint" && typeof o.source_client === "string" && typeof o.destination_client === "string" && typeof o.timeout_timestamp === "bigint" && Array.isArray(o.payloads) && (!o.payloads.length || Payload.isSDK(o.payloads[0])));
  },
