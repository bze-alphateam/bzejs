...
export const MsgSendPacket = {
  ...
  isSDK(o: any): o is MsgSendPacketSDKType {
    return o && (o.$typeUrl === MsgSendPacket.typeUrl || typeof o.source_client === "string" && typeof o.timeout_timestamp === "bigint" && Array.isArray(o.payloads) && (!o.payloads.length || Payload.isSDK(o.payloads[0])) && typeof o.signer === "string");
  },
...
export const MsgTimeout = {
  ...
  isSDK(o: any): o is MsgTimeoutSDKType {
    return o && (o.$typeUrl === MsgTimeout.typeUrl || Packet.isSDK(o.packet) && (o.proof_unreceived instanceof Uint8Array || typeof o.proof_unreceived === "string") && Height.isSDK(o.proof_height) && typeof o.signer === "string");
  },
...
export const MsgAcknowledgement = {
  ...
  isSDK(o: any): o is MsgAcknowledgementSDKType {
    return o && (o.$typeUrl === MsgAcknowledgement.typeUrl || Packet.isSDK(o.packet) && Acknowledgement.isSDK(o.acknowledgement) && (o.proof_acked instanceof Uint8Array || typeof o.proof_acked === "string") && Height.isSDK(o.proof_height) && typeof o.signer === "string");
  },
