...
export const BurnCoinsProposal = {
  typeUrl: "/bze.burner.v1.BurnCoinsProposal",
  is(o: any): o is BurnCoinsProposal {
    return o && (o.$typeUrl === BurnCoinsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string");
  },
  isSDK(o: any): o is BurnCoinsProposalSDKType {
    return o && (o.$typeUrl === BurnCoinsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string");
  },
  isAmino(o: any): o is BurnCoinsProposalAmino {
    return o && (o.$typeUrl === BurnCoinsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string");
  },
