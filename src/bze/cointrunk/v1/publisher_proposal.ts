...
export const PublisherProposal = {
  typeUrl: "/bze.cointrunk.v1.PublisherProposal",
  is(o: any): o is PublisherProposal {
    return o && (o.$typeUrl === PublisherProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.name === "string" && typeof o.address === "string" && typeof o.active === "boolean");
  },
  isSDK(o: any): o is PublisherProposalSDKType {
    return o && (o.$typeUrl === PublisherProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.name === "string" && typeof o.address === "string" && typeof o.active === "boolean");
  },
  isAmino(o: any): o is PublisherProposalAmino {
    return o && (o.$typeUrl === PublisherProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.name === "string" && typeof o.address === "string" && typeof o.active === "boolean");
  },
  ...
  registerTypeUrl() {
    if (!GlobalDecoderRegistry.registerExistingTypeUrl(PublisherProposal.typeUrl)) {
      return;
    }
    GlobalDecoderRegistry.register(PublisherProposal.typeUrl, PublisherProposal);
  }
};