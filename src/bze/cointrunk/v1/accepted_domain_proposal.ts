...
/**
 * @name AcceptedDomainProposalSDKType
 * @package bze.cointrunk.v1
 * @see proto type: bze.cointrunk.v1.AcceptedDomainProposal
 */
...
export const AcceptedDomainProposal = {
  typeUrl: "/bze.cointrunk.v1.AcceptedDomainProposal",
  is(o: any): o is AcceptedDomainProposal {
    return o && (o.$typeUrl === AcceptedDomainProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.domain === "string" && typeof o.active === "boolean");
  },
  isSDK(o: any): o is AcceptedDomainProposalSDKType {
    return o && (o.$typeUrl === AcceptedDomainProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.domain === "string" && typeof o.active === "boolean");
  },
  isAmino(o: any): o is AcceptedDomainProposalAmino {
    return o && (o.$typeUrl === AcceptedDomainProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.domain === "string" && typeof o.active === "boolean");
  },
  ...
  registerTypeUrl() {
    if (!GlobalDecoderRegistry.registerExistingTypeUrl(AcceptedDomainProposal.typeUrl)) {
      return;
    }
    GlobalDecoderRegistry.register(AcceptedDomainProposal.typeUrl, AcceptedDomainProposal);
  }
};