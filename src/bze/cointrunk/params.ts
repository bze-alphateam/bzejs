...
/**
 * Params defines the parameters for the module.
 * @name PublisherRespectParamsSDKType
 * @package bze.cointrunk
 * @see proto type: bze.cointrunk.PublisherRespectParams
 */
...
export const PublisherRespectParams = {
  typeUrl: "/bze.cointrunk.PublisherRespectParams",
  is(o: any): o is PublisherRespectParams {
    return o && (o.$typeUrl === PublisherRespectParams.typeUrl || typeof o.tax === "string" && typeof o.denom === "string");
  },
  isSDK(o: any): o is PublisherRespectParamsSDKType {
    return o && (o.$typeUrl === PublisherRespectParams.typeUrl || typeof o.tax === "string" && typeof o.denom === "string");
  },
  isAmino(o: any): o is PublisherRespectParamsAmino {
    return o && (o.$typeUrl === PublisherRespectParams.typeUrl || typeof o.tax === "string" && typeof o.denom === "string");
  },
  ...
  toAmino(message: PublisherRespectParams): PublisherRespectParamsAmino {
    const obj: any = {};
    obj.tax = message.tax === "" ? undefined : Decimal.fromUserInput(message.tax, 18).atomics;
...
export const Params = {
  typeUrl: "/bze.cointrunk.Params",
  aminoType: "bze/x/cointrunk/Params",
  is(o: any): o is Params {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.anonArticleLimit === "bigint" && Coin.is(o.anonArticleCost) && PublisherRespectParams.is(o.publisherRespectParams));
  },
  isSDK(o: any): o is ParamsSDKType {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.anon_article_limit === "bigint" && Coin.isSDK(o.anon_article_cost) && PublisherRespectParams.isSDK(o.publisher_respect_params));
  },
  isAmino(o: any): o is ParamsAmino {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.anon_article_limit === "bigint" && Coin.isAmino(o.anon_article_cost) && PublisherRespectParams.isAmino(o.publisher_respect_params));
  },
  ...
  registerTypeUrl() {
    ...
    PublisherRespectParams.registerTypeUrl();
  }
};