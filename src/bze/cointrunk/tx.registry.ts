...
export const registry: ReadonlyArray<[string, TelescopeGeneratedType<any, any, any>]> = [["/bze.cointrunk.MsgUpdateParams", MsgUpdateParams], ["/bze.cointrunk.MsgAddArticle", MsgAddArticle], ["/bze.cointrunk.MsgPayPublisherRespect", MsgPayPublisherRespect], ["/bze.cointrunk.MsgAcceptDomain", MsgAcceptDomain], ["/bze.cointrunk.MsgSavePublisher", MsgSavePublisher]];
