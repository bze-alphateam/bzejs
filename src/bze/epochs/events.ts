...
export const EpochStartEvent = {
  typeUrl: "/bze.epochs.EpochStartEvent",
  is(o: any): o is EpochStartEvent {
    return o && (o.$typeUrl === EpochStartEvent.typeUrl || typeof o.identifier === "string" && typeof o.epoch === "string");
  },
  isSDK(o: any): o is EpochStartEventSDKType {
    return o && (o.$typeUrl === EpochStartEvent.typeUrl || typeof o.identifier === "string" && typeof o.epoch === "string");
  },
  isAmino(o: any): o is EpochStartEventAmino {
    return o && (o.$typeUrl === EpochStartEvent.typeUrl || typeof o.identifier === "string" && typeof o.epoch === "string");
  },
...
export const EpochEndEvent = {
  typeUrl: "/bze.epochs.EpochEndEvent",
  is(o: any): o is EpochEndEvent {
    return o && (o.$typeUrl === EpochEndEvent.typeUrl || typeof o.identifier === "string" && typeof o.epoch === "string");
  },
  isSDK(o: any): o is EpochEndEventSDKType {
    return o && (o.$typeUrl === EpochEndEvent.typeUrl || typeof o.identifier === "string" && typeof o.epoch === "string");
  },
  isAmino(o: any): o is EpochEndEventAmino {
    return o && (o.$typeUrl === EpochEndEvent.typeUrl || typeof o.identifier === "string" && typeof o.epoch === "string");
  },
