...
import { AcceptedDomainProposal, AcceptedDomainProposalProtoMsg, AcceptedDomainProposalSDKType } from "../../../bze/cointrunk/v1/accepted_domain_proposal";
import { PublisherProposal, PublisherProposalProtoMsg, PublisherProposalSDKType } from "../../../bze/cointrunk/v1/publisher_proposal";
...
export interface Proposal {
  ...
  content?: TextProposal | AcceptedDomainProposal | PublisherProposal | CommunityPoolSpendProposal | CommunityPoolSpendProposalWithDeposit | ParameterChangeProposal | SoftwareUpgradeProposal | CancelSoftwareUpgradeProposal | Any | undefined;
...
export type ProposalEncoded = Omit<Proposal, "content"> & {
  /** content is the proposal's content. */content?: TextProposalProtoMsg | AcceptedDomainProposalProtoMsg | PublisherProposalProtoMsg | CommunityPoolSpendProposalProtoMsg | CommunityPoolSpendProposalWithDepositProtoMsg | ParameterChangeProposalProtoMsg | SoftwareUpgradeProposalProtoMsg | CancelSoftwareUpgradeProposalProtoMsg | AnyProtoMsg | undefined;
};
/**
 * Proposal defines the core field members of a governance proposal.
 * @name ProposalAmino
...
export interface ProposalSDKType {
  proposal_id: bigint;
  content?: TextProposalSDKType | AcceptedDomainProposalSDKType | PublisherProposalSDKType | CommunityPoolSpendProposalSDKType | CommunityPoolSpendProposalWithDepositSDKType | ParameterChangeProposalSDKType | SoftwareUpgradeProposalSDKType | CancelSoftwareUpgradeProposalSDKType | AnySDKType | undefined;
  status: ProposalStatus;
...
export const Cosmos_govv1beta1Content_InterfaceDecoder = (input: BinaryReader | Uint8Array): AcceptedDomainProposal | PublisherProposal | CommunityPoolSpendProposal | CommunityPoolSpendProposalWithDeposit | TextProposal | ParameterChangeProposal | SoftwareUpgradeProposal | CancelSoftwareUpgradeProposal | Any => {
  const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
  const data = Any.decode(reader, reader.uint32());
  switch (data.typeUrl) {
    case "/bze.cointrunk.v1.AcceptedDomainProposal":
      return AcceptedDomainProposal.decode(data.value);
    case "/bze.cointrunk.v1.PublisherProposal":
      return PublisherProposal.decode(data.value);
  ...
  switch (content.type) {
    case "/bze.cointrunk.v1.AcceptedDomainProposal":
      return Any.fromPartial({
        ...
        value: AcceptedDomainProposal.encode(AcceptedDomainProposal.fromPartial(AcceptedDomainProposal.fromAmino(content.value))).finish()
      });
    case "/bze.cointrunk.v1.PublisherProposal":
      return Any.fromPartial({
        typeUrl: "/bze.cointrunk.v1.PublisherProposal",
        value: PublisherProposal.encode(PublisherProposal.fromPartial(PublisherProposal.fromAmino(content.value))).finish()
      });
  ...
  switch (content.typeUrl) {
    case "/bze.cointrunk.v1.AcceptedDomainProposal":
      return {
        ...
        value: AcceptedDomainProposal.toAmino(AcceptedDomainProposal.decode(content.value, undefined))
      };
    case "/bze.cointrunk.v1.PublisherProposal":
      return {
        type: "/bze.cointrunk.v1.PublisherProposal",
        value: PublisherProposal.toAmino(PublisherProposal.decode(content.value, undefined))
      };
    case "/cosmos.distribution.v1beta1.CommunityPoolSpendProposal":
      return {
